<x-layouts.guest>
    ...
    <form method="POST" action="{{ route('password.update') }}">
        ...
        <div class="space-y-4">
            <x-input label="Email" type="email" name="email" :value="old('email', $request->email)" required autofocus icon="o-envelope" errorField="email" />
            <x-input label="New Password" type="password" name="password" required icon="o-lock-closed" errorField="password" />
